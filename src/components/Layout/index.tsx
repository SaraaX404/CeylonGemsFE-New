      ...
      <div className="flex flex-col bg-gray-100">
          ...
          <div className="flex flex-col">
            <div className="flex flex-row justify-between items-center bg-slate-100 h-[120%]">
              <div className="flex flex-row items-center justify-evenly w-[15%]">
                <h1 className="text-[16px] font-semibold text-gray-700">
                  Follow Us
                </h1>
                <BsFacebook />
                <BsTwitter />
              ...
              <h1 className="text-[17px] font-semibold text-gray-500 my-3">
            ...
            {UserCTX.user?.kyc == "UNVERIFIED" && (
              <KycAlert
                type="error"
                message={"Verify your identity and start buisness"}
              />
            )}
            {UserCTX.user?.kyc == "INREVIEW" && (
              <KycAlert
                type="info"
                message={"We are checking on you, wait patiently"}
              />
            )}
          </div>
        )}
        ...
        <div className={`grid grid-cols-6 items-center`}>
          ...
          {UserCTX.user ? (
            <div className="flex flex-row items-center justify-evenly">
              ...
              <Link href="/profile">
                <button className="border rounded text-[16px] text-gray-600 p-3">
                  My Account
                </button>
              </Link>
            </div>
          ...
          <div className="flex flex-row items-center justify-between mx-[15%] mt-[4%]">
            <div className="flex flex-col items-center border shadow rounded hover:scale-105 transition-transform duration-300">
              ...
              <div className="flex flex-col items-center">
                <h1 className="mb-5 text-gray-700 text-[18px] font-semibold">
                  Happy Customer
                </h1>
              </div>
            </div>
        ...
        <div className="bg-gray-800 h-[550px] mt-[8%]">
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-gray-100 text-[16px] font-semibold mx-[30%] text-center leading-8">
              Explore the world of Ceylon Gems, where beauty meets rarity. Our
              curated collection of exquisite gemstones showcases the vibrant
              hues and unmatched quality that Ceylon is renowned for. From
              sapphires that echo the ocean's depths to rubies that capture the
              fire of passion, our gems are a testament to nature's artistry.
              Join us in celebrating the allure of Ceylon's treasures and embark
              on a journey of timeless elegance.
            </h1>
